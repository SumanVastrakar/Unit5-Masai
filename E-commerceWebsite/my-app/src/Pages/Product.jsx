...
export default function Product() {
  ...
  const currentProduct = useSelector(state => state.ecommerceData.currentProduct)
    ...
    <Container maxW={'7xl'}>
      <SimpleGrid
        ...
        <Stack spacing={{ base: 6, md: 10 }}>
          ...
          <Flex>
           {/* {
    currentProduct != {}  ?  Rating({ rating : Number(currentProduct.rating.rate)}) : ""
           } */}
            {/* {
    currentProduct != {}  ? console.log(currentProduct.rating.rate) : "Empty cart"
           } */}
        {
